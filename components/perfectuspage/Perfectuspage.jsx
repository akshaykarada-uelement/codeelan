...
export default function Perfectuspage() {
    ...
    const features = [
        {
            ...
            description: "Accelerate your time to market by automating repetitive tasks and reducing manual effort.",
            icon: "cycle"
        },
        {
            title: "Improved Test Coverage",
            description: "Ensure comprehensive testing across all platforms and devices, increasing the quality of your software.",
            icon: "flask"
        },
        {
            title: "Reduced Costs",
            description: "Lower operational expenses by minimizing errors and optimizing resource allocation and human intervention.",
            icon: "dollar"
        },
        {
            title: "Monotony Kills Motivation",
            description: "Repetitive testing leads to tester fatigue, where critical details get missed. Demotivated testers means lower productivity and quality.",
            icon: "bug"
        }
    ];
    const keyFeatures = [
        { title: "Improved ROI", desc: "Automation increases test coverage without labor." },
        { title: "Intuitive Interface", desc: "Record-and-play functionality simplifies test creation, making automation accessible to all team members." },
        { title: "Cross-Platform Compatibility", desc: "Seamlessly test web, API, mobile, and performance across different environments." },
        { title: "AI-Powered Insights", desc: "Get actionable recommendations and optimize your testing strategies with machine learning." },
        { title: "Error-Free Execution", desc: "Automation ensures consistent, precise execution." },
        { title: "Consistent Repetition", desc: "Recorded actions play back exactly as intended." },
        { title: "Scaling Automation", desc: "Easily scale automation with more tests or tasks." },
        { title: "Reusable Scripts", desc: "Easily reuse recorded tasks and tests." },
        { title: "Auto Healing", desc: "AI enabled feature to quickly adjust scripts to handle changes." },
        { title: "Less Maintenance", desc: "Recorded scripts reduce time fixing issues." },
        { title: "Easy for Non-Technical Users", desc: "No Code approach let non-technical users automate." },
        { title: "Instant Feedback", desc: "Automation provides quick test results, allowing teams to quickly detect issues and address them." },
        { title: "Reduced Downtime", desc: "System monitoring, performance testing, or maintenance through automation platform minimize downtime." },
    ];
    ...
    const successStories = [
        { number: "01", title: "Increased Efficiency", desc: "Reduced testing time by 80%." },
        { number: "02", title: "Improved Quality", desc: "Decreased bug reports by 50%." },
        { number: "03", title: "Enhanced Productivity", desc: "Freed up developers to focus on innovation." },
    ];
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mx-auto">
                    {features.map((feature, index) => (
                        ...
                        >
                            ...
                            <div className='w-[80%]'>
                                <h3 className="fl4 !text-white mb-3">
                                    {feature.title}
                                </h3>
                ...
                <div className="relative max-w-[1000px] mx-auto">
                    ...
                    {keyFeatures.map((item, index) => {
                        ...
                        return (
                            ...
                            <div key={index} className={`relative flex w-full ${!isLast ? 'pb-24' : ''}`}>

                                <div className={`absolute  md:left-1/2 -translate-x-1/2 w-[1px] bg-white
                            ...
                            `}></div>
                                ...
                                <div className={`hidden md:block w-1/2 ${!isRightAligned ? 'text-right pr-16' : ''}`}>
                                    {!isRightAligned && (
                                        <>
                                ...
                                <div className={`w-full pl-12 md:pl-0 md:w-1/2 ${isRightAligned ? 'md:text-left md:pl-16' : 'md:hidden'}`}>
                                    <h3 className="fl4 !text-white mb-2">{item.title}</h3>
                                    <p className="fl7 !text-white">{item.desc}</p>
                                </div>
            ...
            <div className="section-block-padding container-padding pb-32">
                <div className="relative mb-20 text-center">
                    <h2 className="fl2 !text-white inline-block relative max-w-4xl">
                        Experience the Future: "Perfectus" – Your Business's Automation Superhero

                        <span className="block absolute right-25 md:right-28  -bottom-[2px] w-10 h-2 bg-[#49CF38]"></span>
                    </h2>
                </div>
                ...
                <div className="flex flex-col md:flex-row items-start justify-between gap-12 max-w-7xl mx-auto">
                    ...
                    <div className="w-full md:w-1/3 md:pt-40 ">
                        <h2 className="fl2 !text-white inline-block relative">
                            ...
                            <br />
                            Today
          <span className="block absolute md:right-50 right-35 -bottom-[2px] w-10 h-2 bg-[#49CF38]"></span>
                        </h2>
                    </div>
                    ...
                    <div className="w-full md:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-[#131313] p-8 rounded-sm hover:bg-[#191919] transition-colors group">
                            ...
                            <div className="h-[1px] w-full bg-[#FFFFFF4D] mb-4 group-hover:bg-[#49CF38]"></div>
                            <p className="!text-white fl8">
                                Explore all features and functionalities during your trial period.
                            </p>
                        </div>
                        ...
                        <div className="bg-[#131313] p-8 rounded-sm hover:bg-[#191919] transition-colors group">
                            ...
                            <div className="h-[1px] w-full bg-[#FFFFFF4D] mb-4 group-hover:bg-[#49CF38]"></div>
                            <p className="!text-white fl8">
                                Receive assistance from our expert team to ensure a smooth experience.
                            </p>
                        </div>
