    ...
    return (
        <main className="section-block-padding ">
            ...
            <div className="container-padding">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                    <div className="md:col-span-4">
                        <h4 className="fl4">Interpretation</h4>
                    </div>
                    <div className="md:col-span-8 fl7">
                        <p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mt-8">
                    <div className="md:col-span-4">
                        <h4 className="fl4">Definitions</h4>
                    </div>
                    <div className="md:col-span-8 fl7">
                        ...
                        <ul className="list-disc pl-10 space-y-3">
                            ...
                            <li>
                                ...
                                this Agreement) refers to CodeElan Technologies Pvt. Ltd. ,
                            ...
                            <li>
                                Website refers to CodeElan Technologies, accessible from{" "}
                                <a
                                    href="https://codeelan.com/"
            ...
            <div className="bg-[#F0F0F0] m-7">
                <div className=" container-padding ">
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 py-8 ">
                        <div className="md:col-span-4 flex  gap-3">
                            <span className="w-1 h-9 bg-green-500 transform rotate-[15deg]" />
                            <h2 className="fl3">Collecting and Using Your <br />
                                Personal Data</h2>
                        </div>
                        <div className="md:col-span-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 pt-10">
                        <div className="md:col-span-4">
                            <h4 className="fl6 pl-4">
                                3. Tracking Technologies <br /> and Cookies
                            </h4>
                        </div>
                        <div className="md:col-span-8 fl7">
                            <p className="mb-4">
                            ...
                            <ul className="list-disc pl-5 space-y-4 mb-6">
                                ...
                                <li>
                                    <span className="fl5">Web Beacons:</span>{" "}
                            ...
                            <div className="space-y-4">
                                <ul className="list-disc pl-5 space-y-4 mb-6">
                                    ...
                                    <li>
                                        <p className="fl5">Functionality Cookies</p>
                                        <p className="">Type: Persistent Cookies</p>
                                        <p className="">Administered by: Us</p>
                                        <p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 pt-10">
                        <div className="md:col-span-4">
                            <h4 className="fl4">
                                Retention of Your Personal <br /> Data
                            </h4>
                        </div>
                        <div className="md:col-span-8 fl7">
                            <p className="mb-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 pt-10">
                        <div className="md:col-span-4">
                            <h4 className="fl4">
                                Transfer of Your Personal <br /> Data
                            </h4>
                        </div>
                        <div className="md:col-span-8 fl7">
                            <p className="mb-4">
