  ...
  return (
    <main className="section-block-padding ">
      ...
      <div className="container-padding">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          <div className="md:col-span-4">
            <p className="fl4">Last updated: November 10, 2024</p>
          </div>
          ...
          <div className="md:col-span-8 fl7">
            ...
            <ul className="list-disc pl-10 space-y-3">
              ...
              <li>
                ...
                "Our" in this Agreement) refers to CodeElan Technologies Pvt.
                Ltd. , E402, S3 Lifestyle Internal Rd, Apartments, Pimple
      ...
      <div className="bg-[#F0F0F0] m-7">
        <div className=" container-paddingv2 ">
          ...
          <div className="md:col-span-8">
            <h4 className="fl4 mb-4">Types of Data Collected</h4>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            <div className="md:col-span-4">
              <h4 className="fl6 pl-4">1. Personal Data</h4>
            </div>
            <div className="md:col-span-8 fl7">
              <p className="mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 pt-10">
            <div className="md:col-span-4">
              <h4 className="fl6 pl-4">2. Usage Data</h4>
            </div>
            <div className="md:col-span-8 fl7">
              <p className="mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 pt-10">
            ...
            <div className="md:col-span-8 fl7">
              ...
              <ul className="list-disc pl-5 space-y-4 mb-6">
                <li>
                  <span className="fl5">Cookies or Browser Cookies:</span> A
                ...
                <li>
                  <span className="fl5">Web Beacons:</span> Certain sections of
                  ...
                  an email and for other related website statistics (for
              ...
              <div className="space-y-4">
                <ul className="list-disc pl-5 space-y-4 mb-6">
                  <li>
                    <p className="fl5">Necessary / Essential Cookies</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mt-10">
            <div className="md:col-span-4">
              <h4 className="fl4">Use of Your Personal Data</h4>
            </div>
            <div className="md:col-span-8 fl7">
              <p className="mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 py-10">
            <div className="md:col-span-4">
              <h4 className="fl4">Delete Your Personal Data</h4>
            </div>
            <div className="md:col-span-8 fl7">
              <p className="mb-4">
      ...
      <div className="container-padding">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 pt-10">
          <div className="md:col-span-4">
            <h4 className="fl4">Links to Other Websites</h4>
          </div>
          <div className="md:col-span-8 fl7 ">
            <p>
