    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="relative w-full max-w-md bg-[#0a0a0a] border border-[#222] rounded-lg shadow-2xl p-8">
        ...
        <div className="space-y-6">
          ...
          <button className="!w-full green-btn">Generate Email OTP</button>
        </div>
      </div>
    </div>
  );
...
export default function OmniscientiaPage() {
  ...
  const capabilities = [
    ...
    },
    {
      ...
      title: (
        <>
          Defect Detection & <br /> Quality Inspection
        </>
      ),
    ...
    },
    {
      ...
      title: (
        <>
          Automated Video/Image <br /> data annotation
        </>
      ),
  ...
  const impactStats = [
    {
      title: "Retail Chain",
      description:
        "Improved inventory accuracy with automated shelf monitoring.",
    },
    {
  ...
  return (
    <main className="bg-black min-h-screen">
      {showModal && (
        <UserInformationModal onClose={() => setShowModal(false)} />
      )}
            ...
            <div className="flex flex-col justify-center space-y-8">
              ...
              <div className="space-y-6 fl7 !text-white max-w-3xl">
                ...
                <p>
                  ...
                  image processing techniques to transform video and image data
                  into actionable insights with cutting-edge computer vision
                  solutions.
                </p>
              </div>
                ...
                <button
                  onClick={() =>
                    (window.location.href =
                      "https://omniscientia-dev.codeelan.com/")
                  }
        ...
        <div className="mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="mt-6 fl7 !text-white max-w-[850px] mx-auto">
              ...
              processing techniques to transform video and image data into
              actionable insights with cutting-edge computer vision solutions.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {capabilities.map((item) => (
              ...
              >
                <span
                  className={`absolute fl2 !text-[50px] md:!text-[100px] select-none z-0 group-hover:text-[#222]  ${item.numberClass}`}
                >
                  {item.id}
                </span>

                <div className="relative z-10 h-full flex flex-col justify-end ">
                  <h3 className="fl4 mb-4 !text-white ">{item.title}</h3>
                  <p className="!text-white fl8 w-[70%]">{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className=" mx-auto flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 mb-12 lg:mb-0 lg:pr-16">
            ...
            <p className="!text-white fl7">
              ...
              wide range of industries. From enhancing manufacturing processes
              to improving healthcare diagnostics, our technology is driving
          ...
          <div className="lg:w-1/2 w-full">
            <div className="grid grid-cols-1 md:grid-cols-2">
              {useCases.map((item, index) => (
                <div
                  key={index}
                  className={`flex flex-col items-center justify-center text-center p-12 ${item.borderClass}`}
                >
                  <h3 className="fl4 !text-white mb-4">{item.title}</h3>
                  <p className="!text-white fl8 mx-auto">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="mt-6 fl7 !text-white max-w-[940px] mx-auto ">
              ...
              computer vision accessible and effective. From drag-and-drop model
              building to real-time data visualization, we provide everything
              you need to succeed.
            </p>
          </div>
              ...
              <div className="relative pl-6">
                ...
                <div className="relative pl-10">
                  ...
                  <p className="text-gray-400 text-[15px] leading-relaxed max-w-[380px]">
                    Uncover powerful insights using natural language — interact
                    with video data.
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 space-y-6">
            ...
            <p className="!text-white fl7 max-w-3xl mx-auto ">
              Discover how our computer vision solutions have helped businesses
              achieve remarkable results. From reducing operational costs to
              increasing revenue, our technology is making a real-world impact.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {impactStats.map((item, index) => (
              ...
              >
                <h3 className="!text-white fl4">{item.title}</h3>
                <p className="!text-white fl8 mt-4">{item.description}</p>
              </div>
            ))}
          </div>
        </div>
