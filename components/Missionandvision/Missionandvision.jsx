        ...
        <div className="flex flex-col gap-10">
          <div className="bg-white shadow-[4px_4px_10px_3px_#00000026] p-8 md:p-17">
            <h3 className="fl3 mb-6 flex items-center gap-6">
              <span>
                <img src="/mission/mission2.svg" alt="" />
              </span>{" "}
              Mission
            </h3>
            <p className="fl7">
              At CodeElan, we aim to empower businesses through innovative
              technology solutions that solve complex problems and drive digital
              transformation. By adopting an “Adopt-Build-Operate” approach, we
              deliver exceptional, scalable, and secure solutions tailored to
              each client’s unique journey. Our expertise in AI, computer
              vision, and automation enables us to create intelligent systems
              that enhance decision-making, optimize operations, and unlock new
              possibilities. Our commitment to excellence and continuous
              learning allows us to lead with agility, ensuring success for our
          ...
          <div className="bg-white shadow-[4px_4px_10px_3px_#00000026] p-8 md:p-17">
            <h3 className="fl3 mb-6 flex items-center gap-6">
              <span>
                <img src="/mission/mission3.svg" alt="" />
              </span>{" "}
              Vision
            </h3>
            <p className="fl7">
