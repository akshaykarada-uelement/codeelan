        ...
        <div className="max-w-[90%] w-full flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-0">
              <div className="relative flex flex-col gap-6 h-full md:pr-8 md:border-r-2 md:border-dashed md:border-[#D9D9D980]">
                ...
                <p className="fl8 max-w-[90%]">
                  ...
                  image processing techniques, our platform enables businesses
                  to automate visual tasks with unmatched accuracy, efficiency,
                  and scalability.
                </p>
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-6 text-left">
            ...
            <p className="fl7  mt-4 max-w-[90%]">
              At CodeElan, we specialize in AI/ML, Computer Vision, and cloud
              engineering solutions that drive innovation. We deliver scalable,
              intelligent products, automate processes, and provide actionable
              insights. With AGILE development and robust QA automation, we help
              enterprises integrate and scale cutting-edge technologies to
              enhance their digital transformation.
            </p>
          </div>
        </div>
      </div>
